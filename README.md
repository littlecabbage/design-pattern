...
| 🧬 **05 · 原型模式** | **[👉 05-prototype-pattern.html](https://littlecabbage.github.io/design-pattern/design-pattern-html/01-creational/05-prototype-pattern.html)** | 状态快照 · 智能体思维链 (Tree-of-Thought) 分支环境深度克隆与微秒级状态分叉 |
...
| **05** | **原型模式** *(Prototype)* | 状态快照 · 智能体思维链 (Tree-of-Thought) 分支环境深度克隆与微秒级状态分叉 | 🟢 已上线 | [进入学习](https://littlecabbage.github.io/design-pattern/design-pattern-html/01-creational/05-prototype-pattern.html) |
